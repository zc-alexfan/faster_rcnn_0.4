...
class generic_extractor(vgg16):
  ...
  def forward(self, im_data, im_info, gt_boxes, num_boxes):
    ...
    image_summary.info.dim_scale = generic_extractor._detach2numpy(im_info).squeeze()
    ...
    image_summary.pred.base_feat = generic_extractor._detach2numpy(base_feat).squeeze()
    ...
    image_summary.pred.pooled_feat = generic_extractor._detach2numpy(pooled_feat)
